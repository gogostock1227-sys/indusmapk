...
GROUP_GROUND_TRUTH = {
    ...
    "DDR5/LPDDR5 記憶體": ["2408", "2344", "5269", "2483", "8271"],
    ...
    "充電樁/充電服務": ["2308", "1519", "3023", "6235", "6803"],
...
def evaluate_group(
    ...
    ground_truth = set(GROUP_GROUND_TRUTH.get(group_name, []))
    ...
    for ticker, original_comment in members_with_gt:
        ...
        if vote.verdict == "STRONG_PASS":
            ...
            abstain_basket.append((ticker, real_name, "abstain", "Coverage 缺失，保守保留"))
