...
GROUP_GROUND_TRUTH = {
    ...
    # Phase 11.5 修補（user 抓到）：移除 3037 欣興/2354 鴻準（Coverage 無折疊/鉸鏈相關）
    # 補入 desc 提到的真龍頭：3376 新日興、2385 群光、3532 台勝科、2492 華新科、6182 合晶、4938 和碩、2324 仁寶
    # Phase 11.6 修補（user 第二輪補充）：補入鉸鏈三雄 + UTG 獨家
    #   6805 富世達 — 「全球折疊手機轉軸核心供應商」(奇鋐 3017 子公司)
    #   3548 兆利   — 「全球前三大筆電樞紐，切入摺疊手機鉸鏈」
    #   6456 GIS-KY (業成) — 鴻海集團觸控顯示模組整合，獨家 UTG 超薄玻璃加工
    "折疊機/Apple 新機": [
        "3376",  # 新日興（鉸鏈龍頭，Apple Watch + iPhone Fold 鉸鏈）
        "6805",  # 富世達（折疊手機轉軸核心，水滴轉軸）
        "3548",  # 兆利（摺疊鉸鏈核心成長引擎）
        "6456",  # GIS-KY 業成（鴻海集團，UTG 獨家 + 觸控模組）
        "3008",  # 大立光（鏡頭模組）
        "3406",  # 玉晶光（鏡頭同業）
        "2385",  # 群光（觸控）
        "3532",  # 台勝科（OLED 載板）
...
KEYWORD_EXPANSIONS = {
    ...
    # 政策概念（補關鍵字幫助命中）
    "折疊機/Apple 新機": ["折疊機", "Apple 新機", "iPhone Fold", "iPhone 17", "iPhone 18", "Foldable", "鉸鏈", "Hinge", "UTG", "可折疊", "折疊式"],
