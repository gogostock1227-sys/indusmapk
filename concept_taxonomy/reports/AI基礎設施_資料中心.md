...
- 3231 緯創 `pos=SUBSTRATE` （信心 0.75；產業板塊匹配 (COMP_HW)；必要題材交集：['GB300_RUBIN']；位階「SUBSTRATE」不在白名單（族...）
- 2301 光寶科 `pos=PASSIVE` （信心 0.75；產業板塊匹配 (COMP_HW)；必要題材交集：['GB300_RUBIN', 'LIQUID_COOL']；位階「PA...）
- 2368 金像電 `pos=PCB_HDI` （信心 0.75；產業板塊匹配 (ELEC_COMP)；必要題材交集：['GB300_RUBIN']；位階「PCB_HDI」不在白名單（族...）
- 6933 AMAX-KY `pos=EQUIP` （信心 0.75；產業板塊匹配 (COMP_HW)；必要題材交集：['GB300_RUBIN', 'LIQUID_COOL']；位階「EQ...）
- 3515 華擎 `pos=PASSIVE` （信心 0.75；產業板塊匹配 (COMP_HW)；必要題材交集：['GB300_RUBIN']；位階「PASSIVE」不在白名單（族群 ...）
- 3013 晟銘電 `pos=CONNECTOR` （信心 0.75；產業板塊匹配 (COMP_HW)；必要題材交集：['GB300_RUBIN', 'LIQUID_COOL']；位階「CO...）
- 2345 智邦 `pos=ODM_SYS` （信心 0.70；產業板塊匹配 (NETCOM)；未命中任何必要題材（個股題材 ['LEO_SAT', 'OPTIC_800G_1.6T'...）
- 6414 樺漢 `pos=CHASSIS` （信心 0.70；產業板塊匹配 (COMP_HW)；未命中任何必要題材（個股題材 ['5G_6G', 'ASIC_TPU', 'WIFI7...）
- 6419 京晨科 `pos=ODM_SYS` （信心 0.70；產業板塊匹配 (ELEC_COMP)；未命中任何必要題材（個股題材 ['GLP1_OBESITY', 'LEO_SAT'...）
