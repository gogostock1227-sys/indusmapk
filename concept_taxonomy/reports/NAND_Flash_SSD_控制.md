...
- 2337 旺宏 `pos=MAT_WAFER` （信心 0.65；產業板塊匹配 (AI_SEMI)；必要題材交集：['NAND_TIGHT']；位階「MAT_WAFER」不在白名單（族群...）
- 4967 十銓 `pos=THERMAL` （信心 0.65；產業板塊匹配 (AI_SEMI)；必要題材交集：['NAND_TIGHT']；位階「THERMAL」不在白名單（族群 a...）

## 🔴 應移除（2 檔）

| 代號 | 公司 | 移除原因 | 信心 |
|---|---|---|---:|
| 8271 | 宇瞻 | 產業板塊匹配 (AI_SEMI)；未命中任何必要題材（個股題材 ['COWOS', 'DDR5_RISE', 'HBM3E_HBM4'] vs 族群必要 ['N | 0.25 |
| 3260 | 威剛 | 產業板塊匹配 (AI_SEMI)；未命中任何必要題材（個股題材 ['DDR5_RISE', 'HBM3E_HBM4', 'NICHE_DRAM'] vs 族群必 | 0.25 |
