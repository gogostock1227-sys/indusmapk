...
def _build_spec(name: str, s: dict) -> GroupSpec:
    return GroupSpec(
        ...
        core_keywords=s.get("core_keywords", []),
        exclusion_keywords=s.get("exclusion_keywords", []),
        validation_mode=s.get("validation_mode", "evidence"),
        hard_whitelist=s.get("hard_whitelist", []),
        market_keywords=s.get("market_keywords", []),
        market_evidence_required=s.get("market_evidence_required", False),
